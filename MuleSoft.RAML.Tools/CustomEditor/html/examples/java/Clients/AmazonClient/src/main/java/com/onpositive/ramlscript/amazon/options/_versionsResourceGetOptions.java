...
public class _versionsResourceGetOptions {
    ...
    @XmlElement(name="max-keys")
    public String max_keys;
    ...
    @XmlElement(name="version-id-marker")
    public String version_id_marker;
