...
public class ObjectNameResourceGetOptions {

    @XmlElement(name="response-content-type")
    public String response_content_type;


    @XmlElement(name="response-content-language")
    public String response_content_language;


    @XmlElement(name="response-expires")
    public String response_expires;


    @XmlElement(name="response-cache-control")
    public String response_cache_control;


    @XmlElement(name="response-content-disposition")
    public String response_content_disposition;


    @XmlElement(name="response-content-encoding")
    public String response_content_encoding;
