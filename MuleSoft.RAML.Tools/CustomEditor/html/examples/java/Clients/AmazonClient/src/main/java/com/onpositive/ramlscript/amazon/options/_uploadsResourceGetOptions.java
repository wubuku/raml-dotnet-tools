...
public class _uploadsResourceGetOptions {
    ...
    @XmlElement(name="max-uploads")
    public Double max_uploads;


    @XmlElement(name="key-marker")
    ...
    @XmlElement(name="upload-id-marker")
    public String upload_id_marker;
