...
public class Launcher {
	...
	public static void main(String[] args) {
		...
		//Api api = f.createApi("C:/GIT-repos/raml-labs/automation/input/staging/GoogleMail/api.raml");
		//Api api = f.createApi("C:/GIT-repos/raml-labs/automation/input/staging/GoogleCalendar/api.raml");
		Api api = f.createApi("C:/workspaces/RAML-100apisTest/GIT/GoogleContacts/gc.raml");
		//Api api = f.createApi("C:/GIT-repos/raml-labs/automation/input/staging/Parse/parse.raml");
		print(api);
	}
