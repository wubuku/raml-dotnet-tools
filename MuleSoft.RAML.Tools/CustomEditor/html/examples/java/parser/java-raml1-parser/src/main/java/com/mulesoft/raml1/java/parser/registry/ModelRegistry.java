...
public class ModelRegistry {
    ...
    protected void init(){
        ...
        this.packageMap.put( "Oath1SecuritySchemaSettings", "com.mulesoft.raml1.java.parser.model.methodsAndResources" );

        this.packageMap.put( "Oath1SecuritySchemaSettingsImpl", "com.mulesoft.raml1.java.parser.impl.methodsAndResources" );

        this.packageMap.put( "Oath2SecurySchemaSettings", "com.mulesoft.raml1.java.parser.model.methodsAndResources" );

        this.packageMap.put( "Oath2SecurySchemaSettingsImpl", "com.mulesoft.raml1.java.parser.impl.methodsAndResources" );
