...
namespace MuleSoft.RAML.Tools.CustomEditor
{
    ...
    //     - An empty raml file in the same directory as NewFileItems.vsdir. In
    //       our case we chose api1.raml.raml. Note this file name appears in Editor.vsdir
    ...
    //          - "api1.raml" - This is the base file name. New files will initially
    //             be named as api1.raml1.raml, api1.raml2.raml... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    api1.raml.raml|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - api1.raml.raml - our empty raml file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".raml";
        ...
        #region Fields
        private MuleSoft_RAML_ToolsPackage myPackage;
        ...
        public EditorPane(MuleSoft_RAML_ToolsPackage package)
            : base(null)
        {
            PrivateInit(package);
        }
        ...
        /// <summary>
        /// Initialization routine for the Editor. Loads the list of properties for the raml document 
        /// which will show up in the properties window 
        /// </summary>
        /// <param name="package"></param>
        private void PrivateInit(MuleSoft_RAML_ToolsPackage package)
        {
            myPackage = package;
            loading = false;
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                addCommand(mcs, GuidList.guidMuleSoft_RAML_CmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidMuleSoft_RAML_CmdSet, PkgCmdIDList.IDMX_RTF);
        ...
        {
            pClassID = GuidList.guidMuleSoft_RAML_EditorFactory;
            return VSConstants.S_OK;
        }
