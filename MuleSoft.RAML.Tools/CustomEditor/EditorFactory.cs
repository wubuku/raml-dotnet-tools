...
namespace MuleSoft.RAML.Tools.CustomEditor
{
    ...
    {
        private MuleSoft_RAML_ToolsPackage editorPackage;
        private ServiceProvider vsServiceProvider;


        public EditorFactory(MuleSoft_RAML_ToolsPackage package)
        {
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidMuleSoft_RAML_EditorFactory;
            pgrfCDW = 0;
